...
/** Bottom tab bar. Sits below the docked player. */
export function MobileNav() {
  const pathname = usePathname();

  return (
    <nav className="fixed inset-x-0 bottom-0 z-40 border-t border-border bg-[var(--bar-bg)] pb-[env(safe-area-inset-bottom)] backdrop-blur-xl lg:hidden">
